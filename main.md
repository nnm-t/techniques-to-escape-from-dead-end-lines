...
中国勝山へは姫新線だけでなく中鉄北部バスが運行する岡山～勝山の県内高速バスが存在する。
津山線は概ね1時間毎、姫新線は1日12往復あるが、今回は ~~松山からしまなみ海道経由で向かったが故に~~ ダイヤの都合で津山線経由で乗り継げなかったためこちらを利用した。
1日4往復のみだが全便が蒜山方面への真庭市営バス「まにわくん♡」と接続している ~~乗車した昼前の勝山行だけは40分待たされる~~。
...
東山線沿線で乗客を拾っていくのと、また名古屋高速がなかった頃の名残で名古屋IC (名東区の端にあり、実質的に名古屋東IC) から流入する。
このため東京～名古屋の所要6時間のうち1時間近くを名古屋市内の移動に費やしており、数少ない東西連絡を担う (2号東山線全通でかなりマシになったが) 錦通・広小路通の交通量も多いので渋滞にも捕まりやすい。
...
ちなみに伊勢原～大山ケーブルのバスは各停便のみ停車し、直行便は通過する。それでも20分毎にあるのですぐ乗れる。

10分くらいで到着。
スーツケースを持参していたので手荷物預かりに出したかったものの、17時までに引き取りに行かねばならず断念。
スーツケースを引っ張ったまま階段だらけの参道を歩きケーブルカーに乗り込む。
数年前に新車が投入

阿夫利神社に参拝してから草だんごを食べて下山
帰りは直行便で伊勢原駅へ向かう。急行に乗って町田で下車
