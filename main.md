...
本書では、単純往復に飽きてしまった筆者、そして記事を寄稿してくれたぬえ (@sqen) が試した脱出ルートをレポートしたものです。
乗りテツねっと内のコンテンツ 「**終着駅のない旅** (特に旧コンテンツ: http://noritetsu.net/archive_index.htm)」が情報量が多く参考にする方も多いと考えていますが、この本で執筆したレポートはいずれも掲載のないものです。
...
廃止路線や未成線の場合、多くは代替としてのバス路線が確保されている。
国鉄線の代替路線であれば大判時刻表にも路線と時刻が掲載されており比較的旅程を組み立てやすいが、私鉄の (特に昭和期までに廃止になった路線は) 代替路線はあまり掲載されない。
便数は鉄道時代より増えている路線もあれば平日1往復のみで旅行者の利用が困難な路線もあるなど、まちまちである。

都市部では鉄道路線同士を結び、鉄道空白地帯の市街地を埋めるように走るバス路線が本数も多く使いやすい。

路線バスはバイパスが完成しても旧道から移されずに乗客を拾うルートを維持するため、どうしても距離の割に所要時間が長くなってしまう。
例外は北海道を中心とする人口希薄地帯の長距離路線で、乗降も少なく表定速度が40km/h近くになることもある。
なお、乗車時間が非常に長い路線では主要停留所でのトイレ利用が認められることもある。運転手とも相談して尊厳を保とう。

### バスのりば 駅前だとは 限らない (川柳)

路線の起終点にしていないなど、~~事業者間の大人の事情も含め~~駅前にバスが乗り入れない路線も少なくない。
このような路線は近くを通る幹線道路にバス停が設置されており、そこから乗降することになる。
乗り継ぎ検索でも乗換駅として見なされておらず、検索してもヒットしないこともある。

駅に乗り入れていても表口のバス停とは異なる場所から発着していることもある。
これは異なる方面で乗り場を使い分けるケースが基本だが、同一方面に出ていくバスであっても路線バスと高速バス、バス会社が異なる、などの理由で複数の乗り場を使い分けている事例で多く見かける。
ツアーバス出身の高速バスは東京駅では鍛冶橋駐車場、大阪駅ではプラザモータープールなど、用地の都合で駅からかなり離れた場所から発着する傾向にある。
珍しい例では**最寄り駅から異なる**こともあり、バスタ新宿開業前の新宿駅JRバスのりばは**代々木駅**が最寄りだったことは記憶に新しい。

乗車前にバス停の場所をよく確認しておくこと。乗り継ぎ地点で寄り道をする場合は、予めバス停の場所を確認してから駅を出ると安全である。
最悪の場合、バス停を探しているうちに乗り遅れて旅程崩壊を起こすことになる。

### 運転日に注意

お盆の中日にあたる平日は**JRは平日ダイヤ**、**私鉄は休日ダイヤ**が通例だが、バスにおいては**事業者によって異なる**。
大手事業者は休日ダイヤが適用されることが少なくないようだが、乗車時刻が大きく変わるダイヤでは影響が大きいので事業者へ事前に確認しておくと安全である。
~~筆者は確認を怠って奥津軽いまべつ駅で3時間待ちぼうけ~~

年末年始はほとんど休日ダイヤが適用されるが、民間でも山交バスのように**元日は** (蔵王温泉線などごく一部の路線を除き) **全便運休になる事業者も存在する**ので注意すること。
コミュニティバスも年末年始を運休とする路線が少なくない。

~~当分ないと考えたいが~~2019～2021年のように**特例で休日が追加、変更される時期**は更に変則的になる。
このあたりの対応はその時期にならないと決まらないことから**時期と事業者によりけり**としか言いようがないので、各自乗車前に確認しておくこと。

### コミュニティバスを制する者は盲腸線脱出を制する

盲腸線というと輸送密度の低いローカル線となっている路線も数多い。
そのような路線の終着駅では民間の路線バスが廃止されてしまっており、自治体が運行主体となるコミュニティバスで代替されていることが少なくない。
このコミュニティバスが盲腸線脱出のカギとなることから多かれ少なかれお世話になるものの、**民営の路線バスとは若干趣が異なる**ので、今まで遭遇した事例をもとに紹介する。

多くのコミュニティバスでは朝夕は通学、日中は通院が主な需要で、ダイヤもその流動に合わせて設定されている。
休日は日中の便が運休になるだけでなく、休日全便運休や、平日であっても特定の曜日でしか運行されない路線もある。
このような路線を使う時は旅程全体に影響してくるので、社会人は休暇を何曜日に取得するのかも重要。

閑散路線ではデマンド運行を全区間または一部区間で採用している。
事前に電話すれば来てもらえるものの、**携帯電話が通じない区間を通る路線ではその場で申請できないこともある**。
衛星電話を持って行くのは非現実的なので、そのような場所から乗る場合は着く前に申請しておくこと。

一方で観光地が絡む路線はコミュニティバスであれども毎日運行で比較的利用しやすい。

運賃は長距離であっても100～200円で済む路線もあれば、従量制を採用し1000円以上かかる区間を持つ路線もある。
ほぼ現金のみの対応で、都市近郊を除きICカード対応はほとんど期待できない。

#### Excel時刻表

コミュニティバスでは自治体が運行主体ということもあるのか、時刻表がExcelの表形式で作成されていることが多い。
基本的に市町村のWebサイト内に案内がある。
案内ページが所轄部署の中に置かれているなど階層が深いこともあるので、検索エンジンを使うと早く見つかる。

路線によってはデータが登録されておらず、**乗り継ぎ検索でヒットせず時刻表サイトにも出てこない**。
この場合はもう人力でルートを組むしかない。

#### バス停はどこ?

コミュニティバスは旅行者の利用があまり想定されておらず、路線図があっても地図上にルートをプロットしていない簡易図形式で、バス停の詳細な位置が分からないことも少なくない。
自治体によっては路線図そのものを作成していないこともある。

その場合はGoogleマップやストリートビューでバス停の場所を確認する。
地点の登録があればGoogleマップで検索するとヒットするが、それがない場合はストリートビューで付近の道路を当たってバス停のポールのある場所を確認する。

このテクニックは後述のバス同士の乗り継ぎでも有用で、名称の異なるバス停でも乗り継ぎが可能かどうか確かめる手段となる。

#### 車内アナウンスが無い

マイクロバスやバン (ハイエースなど) を使う路線もあり、車内案内表示器や運賃箱、車内アナウンス、降車ボタンがないこともある。
そのような路線ではフリー乗降制を採用していることも多く申告すればすぐに降ろしてもらえるが、おおよそ土地勘がない場所なので乗車する時点で予め下車地を申告しておくと所定の場所で降ろしてもらえる。
運賃箱に両替機能がない (もしくは運賃箱がない) 場合は手両替をしてくれるが釣り銭の持ち合わせがないことも否定できないので、事前に小銭を多く持っておいた方が安全である。
バンを使う路線では定員が少なく満席では乗車できない、自分の座席に収まらない荷物を持ち込めない、といった案内がなされることもあるので要注意。
...
県を跨ぐような広域移動とバス停の配置次第だが、思いもよらぬ滅茶苦茶な脱出ルートを開拓することができる可能性を秘めている。

もっとも盲腸線の終着駅から徒歩圏内で直接高速バスに乗れる場所は少なく (北条鉄道北条町駅～アスティアかさい/高速北条など)、大抵は路線バスなど二次交通を挟むことになる。
この場合は高速バスと路線バス、両方の発着時刻を精査することが重要だが、残念ながら両路線の接続が考慮されているとは限らない。
短い待ち時間で乗り継げる組み合わせが1日1～2本しかない、ということもある。

問題となるのが定時性で、発着地周辺の一般道では幹線道路を経由することから時間帯や道路事情によっては大きく遅延してしまうこともある。
その先の交通機関に乗り遅れてしまったら本末転倒である。
一部の路線ではバスロケがあるほか、高速バスはWebで検索すると乗車記が見つかりやすく、走行ルートや渋滞のしやすさをある程度掴む手がかりとなる。

多くは起点付近では乗車専用、終点付近では降車専用となるが、東名ハイウェイバス、名神ハイウェイバスや中国ハイウェイバスなどの国鉄時代からある老舗路線や、一般道経由の特急バスから高速道路経由へ載せ替えられた路線などを中心に高速道路区間にもバス停が設置されており、かつ起終点付近を除き一般路線バスのように自由に乗り降りできる。
中には起終点付近で一般路線バスの代替を兼ねている高速バスも存在し、このような路線では一般道区間のみの利用も可能。

#### 高速道路区間での乗降

高速バスの高速道路区間ではパーキングエリア/サービスエリアやインターチェンジに併設のバス停、本線上のバスストップで乗降扱いを行う。
この手のバス停は他にアクセスする公共交通期間がまったく存在しないこともあり、駅から近い場合は徒歩でこなせるものの、遠い場合はタクシーを利用してアプローチすることになる。

筆者も東名大和BSで東名ハイウェイバスを下車して鶴間駅 (小田急江ノ島線) まで徒歩で抜けたり、佐用ICから中国ハイウェイバスに乗車したとき (当時は西日本豪雨の直後で姫新線が不通) は佐用駅からタクシーを利用した。

鉄道駅から徒歩でアクセスできるバス停も少数ながら存在し、そのようなバス停では利用者も比較的多い。
東名、名神では東名江田 (東急田園都市線あざみ野駅)、東名浜松北 (遠鉄自動車学校前駅) 、東名本宿 (名鉄名古屋本線本宿駅)、京都深草 (京阪本線藤森駅) がよく知られている。
特に東京、大阪の一般道区間は渋滞が頻発することから、手前のバス停で下車して都心へは鉄道で向かい渋滞を回避する手法はよく知られている。

### バス以外の交通手段

- タクシー
  - 公共交通がない区間を抜ける最後の手段。ただし地方では営業時間が決まっていたり運行そのものが無いこともある。
  - 1人で乗ると運賃が高額なので、人数を集めてグループで利用する時に視野に入る。
  - バスを廃止して乗合タクシーで代替している区間もある。運賃はバスより高くタクシーより安い傾向。
- 航空機
  - 稚内空港や根室中標津空港、能登空港といった長大路線の終点付近にある空港では戻るにも時間を要すので非常に有効。
  - ただし発着便数が少なく航空会社も大手2社のうち片方のみの就航であることも多く (例示した3空港はすべてANAのみ)、運賃は高め。
- 航路
  - 終点が港湾部にある、半島部の終着駅などで有効な手段。両端が鉄道と接続する航路は少なく、少なくとも片方をバスと組み合わせるのが基本。
  - 長距離フェリーがある地域では広域な乗り継ぎも組める。夜行便では宿泊費の節約にもなる。
  - (ほぼ瀬戸内海限定だが) 航路とバスを組み合わせて離島経由で脱出する芸当も不可能ではない。
- 自転車
  - 列車での輪行が可能で、登り坂が続く区間でなければバスの代わりに自転車も選択肢に入る。
    - 東海バス天城線など、輪行が認められるバスも少数存在する。このような路線では登り坂はバスで輪行、下りのみ自転車という組み合わせも可能。
  - レンタサイクルを借りるのも有効 (乗り捨てが可能でないと脱出に使うには難しいが……)。

### おとなしく折り返す

~~脱出テクニックなのにこれを述べてしまうのも本末転倒な気もするが~~ なんだかんだでバスで脱出するルートは所要時間がかかる上に、運賃が嵩んでしまう。
潔く折り返した方が早いことも少なくない。
...
![琴電志度駅 (JR志度駅からは道路と踏切を渡った先にある)](images/yakuri-yakuritozanguchi/DSC06585.jpg){width=7.5cm}
...
