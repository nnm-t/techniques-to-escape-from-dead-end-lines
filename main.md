...
そのような路線の終着駅では民間の路線バスが廃止されてしまっており、自治体が運行主体となるコミュニティバスへ置き換えられていることが少なくない。

朝夕は通学、日中は通院が主な需要である。
休日運休や、平日でさえ特定の曜日でしか運行されない路線もある。
このような路線を使う時は旅程全体に影響してくる。社会人の方々は休暇をどの日に取得するか考えた上で実行すること。

一方で観光地が絡む路線はコミュニティバスであれど毎日運行で比較的利用しやすいものもある。
...
路線によってはデータが登録されておらず、**乗り継ぎ検索でヒットしない**こともある。
...
多くは起点付近では乗車専用、終点付近では降車専用となるが、東名ハイウェイバス、名神ハイウェイバスや中国ハイウェイバスなどの国鉄時代からある老舗路線や、一般道経由の特急バスから高速道路経由へ載せ替えられた路線などを中心に高速道路区間にもバス停が設置されており、起終点付近を除き一般路線バスのように自由に乗り降りできる。
...
特に東京、大阪の一般道区間は渋滞が頻発することから、手前のバス停で下車して都心へは鉄道で向かい渋滞を回避するテクニックもある。
